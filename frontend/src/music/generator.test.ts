...
describe('generateMontuno', () => {
  const baseState: AppState = {
    ...
    seed: 123,
    chords: [
      { index: 0, name: 'Cmaj7', modo: 'Tradicional', armonizacion: 'Octavas', inversion: null },
      { index: 1, name: 'F7', modo: 'Tradicional', armonizacion: 'Octavas', inversion: null },
      { index: 2, name: 'G7', modo: 'Tradicional', armonizacion: 'Octavas', inversion: null },
      { index: 3, name: 'Cmaj7', modo: 'Tradicional', armonizacion: 'Octavas', inversion: null },
    ],
    errors: [],
    isPlaying: false,
    generated: undefined,
