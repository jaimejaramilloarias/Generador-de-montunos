(function(){"use strict";var r=`"""Backend package exposing the montuno generation core."""
...
def clean_tokens(txt: str) -> str:
    ...
    return result
`,N=`"""Helpers for style parsing and application."""
