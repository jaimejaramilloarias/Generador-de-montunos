(function(){"use strict";var N=`"""Backend package exposing the montuno generation core."""
...
def clean_tokens(txt: str) -> str:
    ...
    return result
`,r=`"""Helpers for style parsing and application."""
...
`,l=`"""Static configuration shared between the desktop UI and the web core."""
...
`,p=`"""Utilities to render montunos without relying on the Tk GUI."""
from __future__ import annotations
...
`,T=`"""Simplified \`\`pretty_midi\`\` implementation for the Pyodide build.
